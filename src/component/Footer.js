    ...
    <div className='footer'>
        <Container className='footer-container'>
            ...
            <div className='second-area'>
                <FooterBox img="http://www.bongousse.net/image/footer/footer-img08.gif" 
                text="매일경제 주최 2015" text2="100대 프렌차이즈 선정"/>
                <FooterBox img="http://www.bongousse.net/image/footer/footer-img01.gif" 
                text="2013 대한민국 대표" text2="우수기업 인증"/>
                <FooterBox img="http://www.bongousse.net/image/footer/footer-img02.gif" 
                text="2014" text2="우수프랜차이즈"/>
                <FooterBox img="http://www.bongousse.net/image/footer/footer-img04.gif" 
                text="소상공인진흥공단" text2="동반성장 우수기업 선정"/>
                <FooterBox img="http://www.bongousse.net/image/footer/footer-img07.gif" 
