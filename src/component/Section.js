    ...
    <div className='outer'>
      ...
      <div className='section2'>
        <div className='imgArea'>
          <img className={ImgAnimation ? "img1 active" : "img1"} src="http://www.bongousse.net/img/menu/img_burger01.png" alt="" />
          <img className={ImgAnimation ? "img2 active" : "img2"} src="http://www.bongousse.net/img/menu/img_burger04.png" alt="" />
        </div>
